...
func Get(ctx context.Context, selector string) v1.ClusterIssuerInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/net-certmanager/pkg/client/certmanager/informers/externalversions/certmanager/v1.ClusterIssuerInformer with selector %s from context.", selector)
	}
