...
import (
	...
	fake "knative.dev/net-certmanager/pkg/client/certmanager/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/net-certmanager/pkg/client/certmanager/clientset/versioned/fake.Clientset from context.")
	}
