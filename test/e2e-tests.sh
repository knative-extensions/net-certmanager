...
go_test_e2e -timeout=10m knative.dev/serving/test/conformance/certificate/nonhttp01 "--certificateClass=${CERTIFICATE_CLASS}" || fail_test
...
go_test_e2e -timeout=10m knative.dev/serving/test/conformance/certificate/http01 "--certificateClass=${CERTIFICATE_CLASS}" || fail_test
